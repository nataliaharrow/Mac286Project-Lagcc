...
public class Trade {
	...
	public void setHoldingPeriod(int h) {
		this.holdingPeriod=h;
	...
	public String toString() {
		...
		String st = "Symbol:"+symbol+ "\tEntryDate:" + sdf.format(entryDate) + " " + "EntryPrice:" + df.format(entryPrice) + "\t\tStopLoss:" + df.format(stopLoss) + 
		"\tTarget:" + df.format(target) + "\tDirection:" + dir +"\tExitDate:" + sdf.format(exitDate) + "\tExitPrice:" + df.format(exitPrice) + " " + "PercentPL:" +
		df.format(this.percentPL()) + "%";
		return st;
	}
